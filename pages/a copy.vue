        ...
        <div>
                                                    ...
                                                    <b-table class="tablePerp" filter-debounce="100"
                                                        ...
                                                        <template #cell(lastPrice)="data">
                                                            ...
                                                            <span style="color:#0CCB80"
                                                                v-else-if="data.item.ps === 'up'">{{ data.item.bs
                                                                }}</span>
                            ...
                            <b-col cols="12">
                                ...
                                <b-table :filter="filterPerp" filter-debounce="100" sticky-header="50vh"
                                    ...
                                    <template #cell(name)="data">
                                        <span @click="phantich(data.item.name)" class="symName">{{ data.item.name
                                        }}</span>
                                    </template>
                                    ...
                                    <template #cell(funding)="data">
                                        <span style="color:#F23545" v-if="data.item.funding < 0">{{ data.item.funding
                                        }}%</span>
            ...
            <div class="modalgroup" style="color:#1E2328 !important">
                ...
                <b-modal ok-only hide-footer scrollable size="xl" title="Tổng thị trường" id="m-tongthitruong">
                    <b-row>
                        <b-col cols="3" v-for="item, index in listCoinWatch" :key="index">
                            <mini-chart :symbol="item"></mini-chart>
                        </b-col>
                    </b-row>
                </b-modal>
                ...
                <b-modal ok-only hide-footer scrollable size="xl" title="Lịch kinh tế" id="m-phantichsymbol">
